...
For more information on thermals, refer to [Track thermal and power states](xref:um-adaptive-performance-track-thermal-timing-data#thermal).
...
For more information on the bottleneck feature, refer to the [Identify performance bottlenecks](xref:um-adaptive-performance-track-thermal-timing-data#bottlenecks).
...
For more information, refer to [Track frame timing](xref:um-adaptive-performance-track-thermal-timing-data#frame-timing).
...
For more information about the Cluster Info feature, refer to [Get cluster information](xref:um-adaptive-performance-track-thermal-timing-data#clusters).
...
For more information, refer to [CPU and GPU performance control](xref:um-adaptive-performance-configuring-cpu-gpu-levels).
...
For more information about performance mode, refer to [Performance control modes](xref:um-adaptive-performance-configuring-cpu-gpu-levels#performance-control-modes).
...
For more information, refer to [Temporary performance boosts](xref:um-adaptive-performance-temporary-performance-boosts).
...
For more information about the individual scalers, refer to [Modifying asset quality with scalers](xref:um-adaptive-performance-scalers-introduction).
